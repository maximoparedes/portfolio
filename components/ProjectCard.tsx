...
export function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <motion.article
      ...
      className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:shadow-xl hover:shadow-zinc-900/5 sm:p-8 dark:border-zinc-800 dark:bg-zinc-900/40 dark:hover:shadow-black/20"
    >
